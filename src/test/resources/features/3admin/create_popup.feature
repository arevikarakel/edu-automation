Feature: This feature will cover possible scenarios of checking password input in create popup of admin page,
  ...
  @TC1.8.3 @TC1.8.8 @TC1.9.11 @TC1.9.14 @TC1.10.12 @TC1.10.15 @Regression @Smoke
  Scenario Outline: Check functionality and structure of 'Generate password' button in create popup
